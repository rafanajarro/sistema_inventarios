...
public class MedidasPesoController {
    ...
    //
    @GetMapping("/obtenerPesosSelect")
    public ResponseEntity<?> obtenerPesos() {
        List<MedidasPeso> medidasPesos = medidasPesoService.obtenerTodos();
        return ResponseEntity.ok(medidasPesos);
    }
