...
public interface ProductoRepository extends JpaRepository<Producto, Integer> {
        ...
        @Query(value = "SELECT P.NOMBRE, SUM(I.CANTIDAD) AS STOCK_ACTUAL FROM PRODUCTO P INNER JOIN INVENTARIO I ON P.ID_PRODUCTO = I.ID_PRODUCTO GROUP BY P.NOMBRE HAVING SUM(I.CANTIDAD) > 100;", nativeQuery = true)
        List<Map<String, Object>> findExcesoStock();
